...
public interface LogoTECListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterSentencia_general(@NotNull LogoTECParser.Sentencia_generalContext ctx);
	/**
	 * Exit a parse tree produced by {@link LogoTECParser#sentencia_general}.
	 * @param ctx the parse tree
	 */
	void exitSentencia_general(@NotNull LogoTECParser.Sentencia_generalContext ctx);
	/**
