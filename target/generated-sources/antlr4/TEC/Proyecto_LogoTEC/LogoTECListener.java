...
public interface LogoTECListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterSisino(LogoTECParser.SisinoContext ctx);
	/**
	 * Exit a parse tree produced by {@link LogoTECParser#sisino}.
	 * @param ctx the parse tree
	 */
	void exitSisino(LogoTECParser.SisinoContext ctx);
	/**
	 * Enter a parse tree produced by {@link LogoTECParser#do_while}.
	 * @param ctx the parse tree
	 */
	void enterDo_while(LogoTECParser.Do_whileContext ctx);
	/**
	 * Exit a parse tree produced by {@link LogoTECParser#do_while}.
	 * @param ctx the parse tree
	 */
	void exitDo_while(LogoTECParser.Do_whileContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link LogoTECParser#sentencia_general}.
	 * @param ctx the parse tree
	 */
	void enterSentencia_general(LogoTECParser.Sentencia_generalContext ctx);
	/**
	 * Exit a parse tree produced by {@link LogoTECParser#sentencia_general}.
	 * @param ctx the parse tree
	 */
	void exitSentencia_general(LogoTECParser.Sentencia_generalContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterCondicion(LogoTECParser.CondicionContext ctx);
	/**
	 * Exit a parse tree produced by {@link LogoTECParser#condicion}.
	 * @param ctx the parse tree
	 */
	void exitCondicion(LogoTECParser.CondicionContext ctx);
	/**
	 * Enter a parse tree produced by {@link LogoTECParser#ordenes_logicas}.
	 * @param ctx the parse tree
	 */
	void enterOrdenes_logicas(LogoTECParser.Ordenes_logicasContext ctx);
	/**
	 * Exit a parse tree produced by {@link LogoTECParser#ordenes_logicas}.
	 * @param ctx the parse tree
	 */
	void exitOrdenes_logicas(LogoTECParser.Ordenes_logicasContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterDefinir_color(LogoTECParser.Definir_colorContext ctx);
	/**
	 * Exit a parse tree produced by {@link LogoTECParser#definir_color}.
	 * @param ctx the parse tree
	 */
	void exitDefinir_color(LogoTECParser.Definir_colorContext ctx);
	/**
