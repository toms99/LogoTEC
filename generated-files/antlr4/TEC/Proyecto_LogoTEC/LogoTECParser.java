...
public class LogoTECParser extends Parser {
	...
	public final AvanzarContext avanzar() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(396); match(ENTERO);
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(397); match(AVANZA);
				setState(398); operacion_aritmetica();
				}
				break;
			}
		}
	...
	public final RetrocederContext retroceder() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(401); match(RETROCEDE);
				setState(402); match(ENTERO);
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(403); match(RETROCEDE);
				setState(404); operacion_aritmetica();
				}
				break;
			}
		}
	...
	public final Girar_derechaContext girar_derecha() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(407); match(GIRA_DERECHA);
				setState(408); match(ENTERO);
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(409); match(GIRA_DERECHA);
				setState(410); operacion_aritmetica();
				}
				break;
			}
		}
	...
	public final Girar_izquierdaContext girar_izquierda() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(413); match(GIRA_IZQUIERDA);
				setState(414); match(ENTERO);
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(415); match(GIRA_IZQUIERDA);
				setState(416); operacion_aritmetica();
				}
				break;
			}
		}
	...
	public final Ocultar_tortugaContext ocultar_tortuga() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(419); match(OCULTA_TORTUGA);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Definir_coordContext definir_coord() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(423); match(PON_POS);
				setState(424); match(PAR_CUAD_ABIERTO);
				setState(425); match(ENTERO);
				setState(426); match(ENTERO);
				setState(427); match(PAR_CUAD_CERRADO);
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(428); match(PON_POS);
	...
	public final EsperarContext esperar() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(446); match(ESPERA);
			setState(447); match(ENTERO);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Ordenes_lienzoContext ordenes_lienzo() throws RecognitionException {
		...
		try {
			...
			case BAJA_LAPIZ:
				enterOuterAlt(_localctx, 2);
				{
				setState(450); dibujar();
				}
				break;
			case SUBE_LAPIZ:
				enterOuterAlt(_localctx, 3);
				{
				setState(451); no_dibujar();
				}
				break;
			case COLOR:
				enterOuterAlt(_localctx, 4);
				{
				setState(452); definir_color();
				}
				break;
			case BORRA_PANTALLA:
				enterOuterAlt(_localctx, 5);
				{
				setState(453); borra_pantalla();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Borra_pantallaContext borra_pantalla() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(465); match(BORRA_PANTALLA);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final DatoContext dato() throws RecognitionException {
		...
		try {
			...
			case COMILLA:
				enterOuterAlt(_localctx, 1);
				{
				setState(467); match(COMILLA);
				setState(468); match(ID);
				setState(469); match(COMILLA);
				}
				break;
			case TRUE:
				enterOuterAlt(_localctx, 2);
				{
				setState(470); match(TRUE);
				}
				break;
			case FALSE:
				enterOuterAlt(_localctx, 3);
				{
				setState(471); match(FALSE);
				}
				break;
			case ID:
				enterOuterAlt(_localctx, 4);
	...
	public final NumeroContext numero() throws RecognitionException {
		...
		try {
			...
			case MENOS:
				enterOuterAlt(_localctx, 2);
				{
				setState(477); operacion_aritmetica();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public static final String _serializedATN =
		...
		"\64\3\64\3\64\3\64\3\64\5\64\u01c9\n\64\3\65\3\65\3\66\3\66\3\67\3\67"+
		"\38\38\38\39\39\3:\3:\3:\3:\3:\3:\3:\5:\u01dd\n:\3;\3;\5;\u01e1\n;\3;"+
		"\2\2<\2\4\6\b\n\f\16\20\22\24\26\30\32\34\36 \"$&(*,.\60\62\64\668:<